...
<div className="fixed">
  ...
  <a className="bg-light text-success col-8 p-2" href="https://api.whatsapp.com/send/?phone=966566642792&text&app_absent=0">‪056 664 2792‬‏</a>
  ...
  <a className="bg-light col-8 text-success p-2" href={`tel:  ‪056 664 2792‬‏:""} `}>‪056 664 2792‬‏</a>
...
<div className="wrapper text-center">
 ...
 {info.snap?<a href={info.snap} className="icon  p-2 github">
  ...
  <a  href="https://api.whatsapp.com/send/?phone=‪056 664 2792‬‏&text&app_absent=0"><i id="coloric"  className="fab fa-whatsapp  fa-1x "></i></a>
  <span className="ppp">‪056 664 2792‬‏</span>
</div>
<div className="row justify-content-around">
    ...
    <li className="col-12 text-lift">
        ...
        <i className="fas fa-map-marker-alt p-2"></i>
          ...
          <li className="col-12 text-lift">
          <span className="text-dark">
           <a href="tel:‪056 664 2792‬‏">‪056 664 2792‬‏</a>
          </span>
